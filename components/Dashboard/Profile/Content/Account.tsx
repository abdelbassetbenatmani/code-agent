...
import { AlertTriangle, Bell, CreditCard, Mail, Trash2,  Info, AlertCircle, Calendar, Receipt, Github } from "lucide-react";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";

const Account = () => {
  const [primaryEmail, ] = useState("abdelbasset@github.com");
  ...
  const handleAddSecondaryEmail = () => {
    ...
    //   toast({
    //     title: "Email added",
    //     description: "Secondary email has been added successfully.",
    //   });
    }
  };
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                This email is associated with your GitHub account and cannot be changed here.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Receive emails about your subscription, invoices and payment issues.
                  </p>
                </div>
                <Switch
                  id="billing-alerts"
            ...
            <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    This will permanently delete your data. Since you use GitHub login, you&apos;ll no longer be able to access your account.
                  </DialogDescription>
                </DialogHeader>
