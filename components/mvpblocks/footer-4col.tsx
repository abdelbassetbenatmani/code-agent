...
const contactInfo = [
  { icon: Mail, text: 'contact@codiny.com' },
  { icon: Phone, text: '0673647702' },
  { icon: MapPin, text: 'Algeria', isAddress: true },
];

export default function Footer4Col() {
  return (
    <footer className="mt-16 w-full place-self-end rounded-t-xl bg-secondary ">
        ...
        <div className="mt-12 border-t pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="text-secondary-foreground/70-foreground mt-4 text-sm transition sm:order-first sm:mt-0">
              &copy; 2025 Codiny. All rights reserved.
            </p>
          </div>
        </div>
      </div>
