...
const plans = [
  {
    ...
    description: "A perfect place to experiment and build personal projects.",
    features: [
      "Single-user workspace",
      "50 AI review/refactor credits/month",
  ...
  },
  {
    ...
    price: {
      monthly: 15,
      yearly: 12, // 20% off for yearly billing
    },
    description: "Everything you need to build and scale your team’s workflow.",
    features: [
      "Up to 10 team members",
      "500 AI review/refactor credits/month",
      "Pay as you go for additional credits",
  ...
  },
  {
    ...
    description: "Custom solutions with full visibility and compliance.",
    features: [
      "Unlimited team members",
      "Unlimited AI review/refactor credits",

      "Custom Coins per team member",
      "Advanced code suggestions",
      "Advanced audit logs (unlimited)",
